...
from src.features.llm.application.agents.card_parser import CardParser
from src.features.llm.application.agents.bio_generator import BioGenerator
from src.features.llm.dependencies.services import get_llm_service, get_prompt_service
